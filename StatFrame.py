...
from tkinter import Tk, Frame, StringVar, Label, Entry, Button, END
...
class StatFrame(Frame):
    def __init__(self, master: Tk):
        ...
        self.xmin = StringVar(value = '')
        self.xmax = StringVar(value = '')
        self.ymin = StringVar(value = '')
        self.ymax = StringVar(value = '')
        self.getLimits()
    ...
    def configureLayout(self):
        ...
        Entry(self, textvariable = self.xmin, width = 10).grid(column = 7, row = 2, sticky = 'nw')
        Entry(self, textvariable = self.xmax, width = 10).grid(column = 7, row = 3, sticky = 'nw')
        Entry(self, textvariable = self.ymin, width = 10).grid(column = 9, row = 2, sticky = 'nw')
        Entry(self, textvariable = self.ymax, width = 10).grid(column = 9, row = 3, sticky = 'nw')
